    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item">
                        <x-utils.link :href="route('frontend.user.products')" :active="activeClass(Route::is('frontend.user.products'))" :text="__('Products')" class="nav-link" />
                    </li>

                    <li class="nav-item">
                        <x-utils.link :href="route('frontend.user.account')" :active="activeClass(Route::is('frontend.user.account'))" :text="__('My Account')" class="nav-link" />
                    </li>
